...
$of_options[] = array( 	"name" 		=> __('Tracking Code','iwebtheme'),
						"desc" 		=> __('Paste your Google Analytics (or other) tracking code here. This will be added into the header template of your theme.','iwebtheme'),
						"id" 		=> "google_analytics",
						"std" 		=> "",
						"type" 		=> "textarea"
				);
...
$of_options[] = array( 	"name" 		=> "Page title",
						...
						"id" 		=> "error_title",
						"std" 		=> "SORRY BRO! THIS PAGE HAS NOT BEEN CREATED YET!",
						"type" 		=> "text"
				);				
...
$of_options[] = array( 	"name" 		=> "Page content",
						...
						"id" 		=> "error_content",
						"std" 		=> "Please check back into the homepage.",
						"type" 		=> "textarea"
				);					
