...
class Moderna_WP_Widget_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('moderna-recent-posts', __('Framework Recent Posts', 'iwebtheme'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Framework Recent Posts', 'iwebtheme') : $instance['title'], $instance, $this->id_base);
