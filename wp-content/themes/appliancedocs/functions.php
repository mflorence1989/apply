...
function iwebtheme_enqueue_css() {
  ...
  wp_enqueue_style('bxsliderstyle', 'https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.css', 'style');
...
function iwebtheme_enqueue_js() {
  ...
  wp_enqueue_script('bxsliderstyle', '"https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.min.js' ,'jquery', '1.9.2', TRUE);
  wp_enqueue_script('bxslider', get_template_directory_uri() . '/js/bxslider.js','jquery', '1.9.2', TRUE);
